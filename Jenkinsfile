                ...
                script {
                    ...
                    sshagent(['ansible-server']){
                        def runplaybook = 'ansible-playbook -i /home/ansadmin/hosts -i /home/ansadmin/docker-compose.yaml /home/ansadmin/continous-deployment.yml'
                         withCredentials([usernamePassword(credentialsId: 'dockerhost-ansadmin-user',usernameVariable: 'USER', passwordVariable: 'PASS')]){
                        sh "sshpass -p ${PASS} scp -v -o StrictHostKeyChecking=no docker-compose.yaml ansadmin@172.31.20.25:/home/ansadmin  "
                    }
